...
export default function AdminDashboard() {
  ...
  if (!stats) return <div className="p-8 text-center text-muted-foreground">Accès réservé à l'administrateur.</div>;
  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        {[
          { label: "Total Dossiers", value: stats.totalApplications, icon: FileText, bg: "bg-blue-50", color: "text-blue-600" },
          { label: "En Révision", value: stats.pendingReview, icon: Clock, bg: "bg-amber-50", color: "text-amber-600" },
          { label: "Approuvés (Mois)", value: stats.approvedThisMonth, icon: CheckCircle2, bg: "bg-green-50", color: "text-green-600" },
          { label: "Clients Actifs", value: stats.totalClients, icon: Users, bg: "bg-purple-50", color: "text-purple-600" },
        ].map((stat, i) => (
